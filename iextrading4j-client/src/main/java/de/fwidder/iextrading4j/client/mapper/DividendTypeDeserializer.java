...
import static de.fwidder.iextrading4j.api.stocks.DividendType.DIVIDEND_INCOME;
import static de.fwidder.iextrading4j.api.stocks.DividendType.INTEREST_INCOME;
import static de.fwidder.iextrading4j.api.stocks.DividendType.LONG_TERM_CAPITAL_GAIN;
import static de.fwidder.iextrading4j.api.stocks.DividendType.MEDIUM_TERM_CAPITAL_GAIN;
import static de.fwidder.iextrading4j.api.stocks.DividendType.SHORT_TERM_CAPITAL_GAIN;
import static de.fwidder.iextrading4j.api.stocks.DividendType.STOCK_DIVIDEND;
import static de.fwidder.iextrading4j.api.stocks.DividendType.UNSPECIFIED_TERM_CAPITAL_GAIN;
