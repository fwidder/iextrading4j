...
[![Quality Gate](https://sonarcloud.io/api/project_badges/measure?project=de.fwidder%3Aiextrading4j&metric=alert_status)](https://sonarcloud.io/dashboard/index/de.fwidder:iextrading4j)
[![Maven Central](https://img.shields.io/maven-central/v/de.fwidder/iextrading4j-all.svg?label=Maven%20Central)](https://search.maven.org/search?q=g:%22de.fwidder%22%20AND%20a:%22iextrading4j-all%22)
...
```
dependencies {
	compile 'de.fwidder:iextrading4j-all:3.4.5'
}
```
